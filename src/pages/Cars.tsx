...
//     const {data} = await axios.post('/api/v1/bookings/check-availability', {location: pickupLocation, pickupDate, returnDate})
//     if(data.success){
...
//           <Title title='Available Cars' subTitle='Broese our selection of premium
...
function Cars() {
  ...
  const { cars: allCars, axios } = useAppContext()
