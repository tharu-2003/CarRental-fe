...
import { getDashboardData } from '../../services/owner'
...
const Dashboard: React.FC = () => {
  ...
  const dashboardCards: ICard[] = [
    { title: 'Total Cars', value: data.totalCars, icon: assets.addIconColored },
  ...
  const fetchDashboardData = async () => {
    try {
      // const { data: res } = await axios.get('/api/v1/owner/dashboard')
