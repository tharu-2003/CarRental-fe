...
const AddCar = () => {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      ...
      booking. ncluding pricing, availability, and car specifications' />
      ...
      text-sm mt-6 max-w-xl'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
          ...
          <div className='flex flex-col w-full'>
            ...
            className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.year} onChange={e=> setCar({...car, pricePerDay: e.target.value})}/>
          </div>
          <div className='flex flex-col w-full'>
        ...
        <div className='flex flex-col w-full'>
            ...
            and a powerful engine' required className='px-3 py-2 mt-1 border 
